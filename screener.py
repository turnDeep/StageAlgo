...
def main():
    ...
    # 移行日が判明している銘柄の統計
    known_transition = results_df[results_df['Stage2_Transition_Date'] != 'Unknown']
    if len(known_transition) > 0:
    ...
    display_cols = [
        'Ticker', 'Exchange', 'Stage2_Transition_Date',
        'Days_Since_Transition', 'RS_Rating', 'Current_Price'
    ]
