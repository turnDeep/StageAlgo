...
| カテゴリ | 評価項目 | 配点 |
|:---|:---|:---|
| 出来高 | ブレイクアウト時の出来高急増 | 20点 |
| 価格 | 50日高値からのブレイクアウト | 25点 |
| トレンド | MA50のゴールデンクロスと傾き | 20点 |
| 相対強度 | RS Ratingの強さ | 15点 |
| ボラティリティ | ATRを用いたトレンド初動の検知 | 15点 |
| 市場環境 | ベンチマーク(SPY)の全体相場 | 5点 |
| **合計** | | **100点** |

**ブレイクアウトの確認**: スコアに加え、ブレイクアウトが「本物」であるかを確認するため、高値更新後に株価がその水準を**2日以上維持**できたかをチェックします。
